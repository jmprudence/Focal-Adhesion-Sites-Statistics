...
#04 May    2022 - Added consistent mark manipulation 
...
#11. If the group is not population, the marks are all manipulated a certain percent 
...
PerChng <- 0 #readline(prompt ="Enter Percentage of Mark Size (i.e. 1% larger is 1.01):")
...
for (i in 1:length(file_list)){
  ...
  #If group is not population, multiply area by user inputted change 
  if(group != "population"){
