...
#02 June   2022 - Added shifting of FA sites based on user inputted data 
...
#11. If the group is not population, the FA sites are shifted using rjitter
...
results_folder <- #Enter path to random sampling folder
...
for(r in 1:reps){
  ...
  path <- #Enter path to large group cells 
...
for (i in 1:length(file_list)){
  ...
  # If the group is not the population, shift FA sites based on user input
  if(group != "population"){
