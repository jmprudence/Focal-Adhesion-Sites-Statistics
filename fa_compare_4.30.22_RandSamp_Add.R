...
for(r in 1:reps){
  ...
  path <- "C:/Users/jayre/Documents/Focal Adhesion Statistics/Population/"
  ...
  path <- "C:/Users/jayre/Documents/Focal Adhesion Statistics/Actual/"
  ...
  np <- 99
  mp <- 10
  results[[r]] <- studpermu.test(focal_adhesion, FA_centroids ~ group, nperm=np, minpoints = mp)
